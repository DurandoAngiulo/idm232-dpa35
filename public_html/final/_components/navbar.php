<nav class="navbar navbar-expand-sm bg-light shadow-sm border-bottom">
  <div class="container-fluid whiteGrayBackground px-5">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav container-fluid d-flex">
        <a class="nav-link me-auto" href="<?php echo site_url(); ?>/explore.php">Explore</a>
